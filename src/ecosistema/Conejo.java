...
//Conejo: animal herbívoro. Come plantas y se reproduce si tiene energía suficiente y hay al menos otro conejo vivo. Extiende {@link Animal} e implementa {@link Reproducible}
public class Conejo extends Animal implements Reproducible {
    ...
    // En su turno el conejo se alimenta y luego intenta reproducirse
    @Override
    ...
    // Busca una planta viva en el ecosistema y la come. Si no encuentra ninguna, pierde energía. Nota: el conejo no puede distinguir una planta normal de una venenosa antes de comerla (polimorfismo en serComida()).
    @Override
